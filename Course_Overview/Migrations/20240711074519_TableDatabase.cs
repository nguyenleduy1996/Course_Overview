...
{
    /// <inheritdoc />
    public partial class TableDatabase : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Questions_EntranceExams_EntranceExamExamID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentExams_EntranceExams_EntranceExamExamID",
                        column: x => x.EntranceExamExamID,
                        principalTable: "EntranceExams",
                        principalColumn: "ExamID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Questions_EntranceExamExamID",
                table: "Questions",
                column: "EntranceExamExamID");

            migrationBuilder.CreateIndex(
                name: "IX_StudentExams_EntranceExamExamID",
                table: "StudentExams",
                column: "EntranceExamExamID");
